...
def time():
    ...
    if timer>0:
        ...
        rr= messagebox.askretrycancel('Notification','Play Again and beat your previous score')
        if rr==True:
            score=0
            miss=0
            timer=60
